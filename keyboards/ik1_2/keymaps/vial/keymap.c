...
#define ESCSYM LT(LSYM, KC_ESC)
#define ENTSYM LT(LSYM, KC_ENT)

#define TABNAV LT(LNAV, KC_TAB)
#define NAV MO(LNAV)
...
KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                              KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RGUI,
                                           KC_LSFT, NAV,    ESCSYM,                          ENTSYM,   KC_SPC, KC_LSFT
),

[LSYM] = LAYOUT_split_4x6_3(
_______,    _______,    _______,    _______,    _______,    _______,                            _______,    _______,    _______,    _______,    _______,    _______,
_______,    KC_GRV ,    _______,    _______,    KC_QUOT,    _______,                            KC_EXLM,    KC_PIPE,    KC_LBRC,    KC_RBRC,    KC_PERC,    _______,
_______,    KC_AMPR,    KC_MINS,    KC_PLUS,    KC_EQL ,    KC_HASH,                            KC_SCLN,    _______,    KC_LPRN,    KC_RPRN,    KC_AT  ,    _______,
_______,    _______,    KC_SLSH,    KC_ASTR,    KC_BSLS,    KC_UNDS,                            KC_TILD,    KC_DLR ,    KC_LCBR,    KC_RCBR,    S(KC_SLSH), _______,
...
_______,    KC_UNDS,    KC_PLUS,    KC_LCBR,    KC_RCBR,    KC_TILD,                            KC_HOME,    KC_PGDN,    KC_PGUP,    KC_END,     KC_PSCR,    KC_BSPC,
_______,    KC_MINS,    KC_EQL,     KC_LBRC,    KC_RBRC,    KC_GRV,                             KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   _______,    _______,
_______,    KC_UNDS,    KC_PLUS,    KC_LPRN,    KC_RPRN,    _______,                            KC_INS,     KC_DEL,     KC_MUTE,    KC_VOLD,    KC_VOLU,    _______,
                                                _______,    _______,    _______,    _______,    _______,    _______
),
